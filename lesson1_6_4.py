...
try: 
   ...
   # for element in elements:
    ...
    input1 = browser.find_element(By.XPATH , "//div[@class='first_block']/child::div/input[@class='form-control first']")
    input1.send_keys("Ivan")
    input2 = browser.find_element(By.XPATH , "//div[@class='first_block']/child::div/input[@class='form-control second']")
    input2.send_keys("Petrov")
    input3 = browser.find_element(By.XPATH ,"//div[@class='first_block']/child::div/input[@class='form-control third']")
